...
def apply_code_translation(
    ...
    Examples:
        ...
        ...         "code/vocab_index": [],
        ...     },
        ...     schema={"code": pl.Utf8, "code/vocab_index": pl.UInt32},
        ... )
        >>> apply_code_translation(df, empty_metadata)
        shape: (8, 2)
        ┌────────────┬────────────┐
        │ subject_id ┆ code       │
        │ ---        ┆ ---        │
        ...
        ...     },
        ...     schema={"code": pl.Utf8, "code/vocab_index": pl.UInt32, "translated": pl.Utf8},
        ... )
        >>> apply_code_translation(df, metadata)
        shape: (8, 2)
        ┌────────────┬────────────┐
        │ subject_id ┆ code       │
        │ ---        ┆ ---        │
...
def main(cfg: DictConfig):
    ...
    map_over(cfg, compute_fn=apply_code_translation)
